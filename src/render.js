...
export function drawReport(canvas, model, config, options = {}) {
  ...
  if (transform) {
    ...
    // Os números das áreas são a camada de identificação mais importante:
    // desenhe-os por último para permanecerem legíveis sobre strings,
    // contornos, hachuras, pontos operacionais e o rascunho de uma string.
